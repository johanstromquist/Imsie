              ...
              >
                ...
                >
                  <div style={{ flex: 1 }}>
                    ...
                    >
                      {isSelfAssessment ? (
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(255, 200, 0, 0.9)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
                    ...
                    {isSelfAssessment && !selfAssessmentComplete && (
                      ...
                      >
                        ...
                        Please complete your self-assessment below
                      </div>
                    )}
                  </div>
                  <div
